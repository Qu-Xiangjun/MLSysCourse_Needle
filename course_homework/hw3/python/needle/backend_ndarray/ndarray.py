...
try:
    ...
    # Don't support the system or python version in cpu backend. Convert to numpy.
    ndarray_backend_cpu = ndarray_backend_numpy
...
def cuda():
    ...
    try:
        ...
        print("[ERROR] Don't support current system or python version for cpu backend.")
